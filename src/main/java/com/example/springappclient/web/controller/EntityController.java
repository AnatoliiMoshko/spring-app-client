package com.example.springappclient.web.controller;

import com.example.springappclient.client.EntityModelClient;
import com.example.springappclient.web.model.EntityModel;
...
public class EntityController {
    ...
    @GetMapping
    public Flux<EntityModel> getModels() {
        return client.getModels();
    }

    @GetMapping("/{id}")
    public Mono<EntityModel> getModel(@PathVariable Long id) {
